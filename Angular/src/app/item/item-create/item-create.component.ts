...
import {CustomNgxDatetimeAdapter} from "../../classes/custom-ngx-datetime-adapter";
...
export class ItemCreateComponent {
  ...
  ngOnInit(){
    this.dateControl = new FormControl(this.deadline ? new Date(this.deadline) : new Date());
    if (this.type == 1){
      this.checkTitle()
    }
