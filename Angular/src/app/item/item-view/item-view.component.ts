...
import {faPenToSquare, faGripVertical, faStar, faTrash, faBell} from "@fortawesome/free-solid-svg-icons";
...
export class ItemViewComponent {
  ...
  openDialog(): void {
    let ref = this.dialog.open(ChoiceDialogComponent, {
      ...
      data: {title: "Delete task?", message: `Are you sure you want to
      delete task <b>${this.item?.title}</b>?`,
        id: this.item?.id, type: 1}
    });
